...
import (
	...
	"10.254.25.25:8080/hujun/zt_cmdb/logics"
...
// @Router /zt_cmdb/api/v1/service [post]
...
// @Success 200
// @Router /zt_cmdb/api/v1/service/{id} [delete]
...
// @Router /zt_cmdb/api/v1/service/{id} [put]
...
// @Success 200 {object} models.Service "更新成功返回结果"
// @Router /zt_cmdb/api/v1/service/{id} [patch]
...
// @Router /zt_cmdb/api/v1/service [get]
...
// @Router /zt_cmdb/api/v1/service/{id} [get]
